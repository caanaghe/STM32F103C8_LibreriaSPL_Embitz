...
int main(void)
{
    Sysclk_56M();// configurar el sysclock para calcular la frecuencia del adc, que de menos de 14 Mhz.
...
/***********************************************
 * Inicializacion del reloj Sysclk en 56 Mhz, igual en HCLK y PCLK2. PCLK1 en la mitad
 ***********************************************/
void Sysclk_56M(void)
{
