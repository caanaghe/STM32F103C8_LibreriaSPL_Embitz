/*
** TENER EN CUENTA QUE PARA MEDIR FRECUENCIA Y CICLO UTIL SE DEBEN DE HACER EN LOS CANALES 1 Y 2 SOLAMENTE, Y AMBOS POR CANALES SEPARADOS.
**                           Main.c
**
**
**********************************************************************/
