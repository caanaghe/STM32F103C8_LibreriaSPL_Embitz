...
void Tim3Init(void);
uint32_t get_timer_clock_frequency(void); // permite enviar por el uart la frecuencia del sysclock con que esta trabajando en dispositivo mas no el del pin de entrada..
...
// función para configurar el Tim3, CON INTERRUPCION.
void Tim3Init(void)
{
