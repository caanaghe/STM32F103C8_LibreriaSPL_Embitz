...
/***********************************************
* Inicialización del ADC1 en modo evento para varios canales. EN EL PUERTO A DESDE EL CANAL 0 AL 9.
***********************************************/
void ADC1_Evento_Varios_canal(uint8_t* canales, uint8_t cantidad)
{
    ...
    // configuración de los pines del ADC (PA0 -> canal 0 a PA7 -> canal 7 y del PB0 -> canal 8 y PB1 -> canal 9) como entradas analoógicas.
    ...
    ADC_InitStruct.ADC_NbrOfChannel = cantidad; // 8 canales de conversión
